classdef GPTrajSparseMinAcc < GPTrajSparseBase
    %GPTRAJSPARSEMINACC sparse GP trajectory with zeros acceleration prior
    ...
    methods
        function obj = GPTrajSparseMinAcc(supportPts, supportId, Q_c, mu0, kappa0)

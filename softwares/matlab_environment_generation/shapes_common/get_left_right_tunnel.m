...
for i = 1:(length(vertical_disp)-1)
    ...
    rectangle_array = [rectangle_array get_rectangle_shape(x_com - 0.5*wall_width, bbox(3), wall_width, vertical_disp(i) - 0.5*gap_clearance -bbox(3))];
    rectangle_array = [rectangle_array get_rectangle_shape(x_com - 0.5*wall_width, vertical_disp(i) + 0.5*gap_clearance, wall_width,  bbox(4) - (vertical_disp(i) + 0.5*gap_clearance))];
end

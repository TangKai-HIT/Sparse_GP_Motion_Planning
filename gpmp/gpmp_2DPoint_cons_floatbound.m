%%GPMP 2D states: use gpmp planner to plan a 2D state trajectory with floating boundary states (with controllable variance), enable constraints
clc; clear; close all;
...
gpmpPlanner2D = gpmpFloatBound2D(gpSparseSets, varDim, order, eta, omega, lambda, kappa_goal, options, constraints);
